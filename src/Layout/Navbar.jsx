  ...
  <div className="app_navbar-items flex justify-between items-center w-5/12 sm:w-5/12 lg:w-4/12 xl:w-3/12">
    <div className="app_navbar-items_language cursor-pointer relative font-[200] w-2/5">
      <div className="app_navbar-items_language-icon flex justify-between">
        ...
        <span id="dropdownDefaultButton" data-dropdown-toggle="dropdown" className="ml-2 text-[15px] md:text-[30px] flex items-center">
...
<div id="dropdown" className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-20 dark:bg-gray-700">
  <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
    ...
    <div className="app_navbar-items_bars cursor-pointer text-right mx-1">
      <span className="" data-drawer-target="drawer-example" data-drawer-show="drawer-example" aria-controls="drawer-example">
  ...
  <div id="drawer-example" tabindex="-1" aria-labelledby="drawer-label" className="app_sidebar fixed top-0 left-0 z-[90] h-screen pt-20 px-6 overflow-y-auto transition-transform -translate-x-full w-80 dark:bg-gray-800">
    ...
    <ul className="sidebar_list mt-20 text-center">
      ...
      <li className="sidebar_list-item">
        <Link className="p-2 flex justify-center cursor-pointer text-lg" to="/favourites">Favourites</Link>
      </li>
      <li className="sidebar_list-item">
    ...
    <ul className="app_sidebar-auth mt-10 text-[20px] text-center">
      ...
      <div>
        <li className="mb-4">
          <Link className="btn block" to="/login">Login</Link>
        </li>
        <li>
          <Link className="btn block" to="/register">Register</Link>
        </li>
      </div>
    </ul>
