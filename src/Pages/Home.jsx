          ...
          <div className="items-center text-center">
            ...
            <div className="flex flex-col items-center my-6">
              <div className="app_search-input w-full relative overflow-hidden">
                ...
                <input type="text" required className="w-10/12 border-2 rounded-[46px] h-[47px] md:h-[4rem] indent-[30px] lg:indent-[50px] text-[15px] md:text-[20px]" defaultValue={""} />
              ...
              <Link className="main_btn mt-8 text-[15px] md:text-[25px] px-[85px] md:px-[150px]" to="/search?searchKey=">Search</Link>
            </div>
