...
const Search = () => {
  ...
  <div className="flex flex-col items-start">
    <div className="app_search-input w-5/6 relative overflow-hidden">
      ...
      <input type="text" required className="w-10/12 border-2 rounded-[46px] h-[47px] md:h-[4rem] indent-[40px] px-3 lg:indent-[50px] text-[15px] md:text-[20px]" defaultValue={""} />
      <img className=" absolute md:right-[24%] right-[5.5rem] top-[23%] md:top-[27%] w-[13px] md:w-[24px] cursor-pointer h-[30px] md:h-[32px] border-black" src={deleteMark} alt="Delete Search Text" />
      <span className=" h-[47px] top-[5px] md:top-0 md:h-[72px] w-[1px] absolute md:right-[23%] right-20 bg-black" />
      <span className="absolute md:right-[19%] right-[3.5rem]  top-[15px] md:top-[16px] cursor-pointer text-[16px] md:text-[23px]">
